...
import controller.IDAO_Person;

public class Alumns extends Person implements IDAO_Person {

	private PreparedStatement ps;
	private String table = "Alumns";

	public Alumns(int id, String name, String lastName, int age) {
